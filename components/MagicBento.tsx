...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section relative grid w-full select-none gap-2"
...
const CardWithInteractions: React.FC<{
  children: React.ReactNode;
  className?: string;
  style?: React.CSSProperties;
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative aspect-[4/3] min-h-[200px] w-full max-w-full p-5 rounded-[var(--radius-surface)] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out ${
