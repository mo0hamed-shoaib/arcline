    ...
    <SectionShell>
      <div>
        ...
        <div className="relative w-full overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-y-0 left-0 w-12 md:w-16 marquee-fade-left" />
          <div className="pointer-events-none absolute inset-y-0 right-0 w-12 md:w-16 marquee-fade-right" />
        </div>
      </div>
    </SectionShell>
  );
