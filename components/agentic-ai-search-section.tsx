    ...
    <Reveal>
      <section className="py-12 md:py-16">
        ...
        <div className="mb-6 px-4 text-center md:mb-12">
          ...
          >
            Using Next.js, TypeScript, Tailwind CSS, shadcn/ui and Supabase to build exactly what
            you need.
          </p>
        </div>
                            ...
                            <div className="flex items-start gap-2">
                              <div className="min-w-0 flex-1">
                                ...
                                <div className="mb-1 flex items-center gap-2">
                                  <span
                                    className={`rounded border px-1.5 py-0.5 text-[10px] font-medium transition-all duration-300 ${getCategoryColor(
                                      query.category
                                    )} ${activeQuery.id === query.id ? "animate-pulse-slow" : ""}`}
                                    style={{
                                      fontFamily: "var(--font-geist-mono)",
                                    }}
                                  >
